...
- **Floating Toast**: `build_toast` continua a generare messaggi in alto a destra ma ora li anima con `requestAnimationFrame` e li ancoriamo a un contenitore `fixed` per tenerli visibili anche quando si scorre la tab.
