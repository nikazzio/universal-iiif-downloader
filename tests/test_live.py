...
class TestProviders(unittest.TestCase):
    ...
    def test_01_vatican_resolver(self):
        """Verify Vatican resolver without downloading content."""
    ...
    def run_partial_download(self, url, name):
        ...
        scans_dir_path = Path(d.scans_dir)
        self.assertTrue(scans_dir_path.is_dir(), "Scans directory was not created")
        jpgs = [f.name for f in scans_dir_path.iterdir() if f.name.startswith("pag_") and f.name.endswith(".jpg")]
